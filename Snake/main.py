...
class MAIN:
    ...
    def check_collision(self):
        ...
        # fruit cannot appear under body of snake
    ...
    def draw_score(self):
        ...
        bg_rect = pygame.Rect(apple_rect.left - 6, apple_rect.top -5, apple_rect.width + score_rect.width + 10, apple_rect.height+10)
...
game_font = pygame.font.Font('Fonts\BabyGemoy-nARoV.ttf', 25)
...
while True:
    for event in pygame.event.get():
        ...
        clock.tick(60) #framerate (6o frames per second)    
